...
# -----------------------------------------------------------------------------
field_patterns = {
<<<<<<< HEAD:team_wisteria/coursework_one/a_pipeline/src/content_extract.py
    "scope_1_emissions": { 
        "keywords": ["Scope 1", "Direct GHG emissions"], 
        "regex": r"(?:Scope\s*1[^0-9a-zA-Z]{0,15})[:\-]?\s*(\d{1,3}(?:[ ,]?\d{3})*(?:\.\d+)?)(?=\s*(tCO2e?\b|tons\b|tonnes\b))"
    }, 
=======
...
>>>>>>> ddd0ad2d6f8de38539c8ea5d37d4554498d5af06:team_wisteria/coursework_one/a_pipeline/static/content extract.py
    "scope_2_emissions": {
...
<<<<<<< HEAD:team_wisteria/coursework_one/a_pipeline/src/content_extract.py
    PG_PORT = int(os.getenv("PG_PORT", 5439))         
=======
...
<<<<<<< HEAD:team_wisteria/coursework_one/a_pipeline/src/content_extract.py
        ...
        try:
            ...
            print(f"⚠️  {comp}-{yr} can not find matched txt {txt_key}")
            continue
...
<<<<<<< HEAD:team_wisteria/coursework_one/a_pipeline/src/content_extract.py
    ...
    print(f"completed！total {len(results)},write in{Config.JSON_PATH} + DB csr_indicators")
=======
